...
export interface SolarEclipseInterpretation {
  ...
  frequency: string;
  duration: string;
  planet1Energy: string; // What a Solar Eclipse is (karmic reset, destiny activation, new beginnings)
  planet2Energy: string; // The zodiac sign's energy (e.g., Aries = courage, initiative)
  aspectMeaning: string; // High-level interpretation of Solar Eclipse in this sign
...
export interface NewMoonInterpretation {
  ...
  frequency: string;
  duration: string;
  planet1Energy: string; // What a New Moon is (new beginnings, fresh starts, planting seeds)
  planet2Energy: string; // The zodiac sign's energy (e.g., Aries = courage, initiative)
  aspectMeaning: string; // High-level interpretation of New Moon in this sign
  loveRelationships: string;
  familyHome: string;
  businessCareer: string;
  moneyFinances: string;
...
export interface FullMoonInterpretation {
  ...
  frequency: string;
  duration: string;
  planet1Energy: string; // What a Full Moon is (culminations, completions, revelations)
  planet2Energy: string; // The zodiac sign's energy (e.g., Aries = courage, initiative)
  aspectMeaning: string; // High-level interpretation of Full Moon in this sign
  loveRelationships: string;
  familyHome: string;
  businessCareer: string;
  moneyFinances: string;
...
export interface LunarEclipseInterpretation {
  ...
  frequency: string;
  duration: string;
  planet1Energy: string; // What a Lunar Eclipse is (emotional release, karmic completion, endings)
  planet2Energy: string; // The zodiac sign's energy (e.g., Aries = courage, initiative)
  aspectMeaning: string; // High-level interpretation of Lunar Eclipse in this sign
  loveRelationships: string;
  familyHome: string;
  businessCareer: string;
  moneyFinances: string;
...
const SOLAR_ECLIPSES: Record<string, SolarEclipseInterpretation> = {
  'Aries': {
    ...
    planet1Energy: 'Solar Eclipse represents a MAJOR karmic reset, destiny activation, and powerful new beginning. It\'s a cosmic reboot where old chapters end and fated new ones begin. Eclipses bring sudden changes, destined events, and 6-month to 1-year transformation cycles. This is about karmic course corrections and soul-level evolution.',
    planet2Energy: 'Aries represents new beginnings, courage, independence, leadership, initiative, passion, and the warrior spirit. It\'s the spark of self-assertion, the drive to be first, and the courage to start fresh.',
    aspectMeaning: 'A Solar Eclipse in Aries marks a powerful reset in how you assert yourself and pursue your individual path. This is a cosmic new beginning for your identity, independence, and courage. Old versions of yourself die so bolder ones can emerge. Expect sudden shifts in your sense of self, leadership opportunities, or the courage to break free and start something entirely new. This eclipse says: "Who you were is ending. Who you\'re becoming is braver."',
  ...
  'Leo': {
    ...
    duration: '~6 months of influence',
    planet1Energy: 'Solar Eclipse represents a MAJOR karmic reset, destiny activation, and powerful new beginning. It\'s a cosmic reboot where old chapters end and fated new ones begin. Eclipses bring sudden changes, destined events, and 6-month to 1-year transformation cycles. This is about karmic course corrections and soul-level evolution.',
    planet2Energy: 'Leo represents creativity, self-expression, joy, confidence, recognition, leadership, romance, and the radiant performer. It\'s the urge to shine, to create, to be seen and celebrated for who you truly are.',
    aspectMeaning: 'A Solar Eclipse in Leo initiates major rebirth in self-expression, creativity, and how you shine in the world. This eclipse says: "Stop dimming your light. Express who you really are." Sudden opportunities or crises around creative expression, romance, children, or public recognition force you to claim your authentic radiance. Old ways of seeking approval die so you can shine for your own joy, not others\' applause.',
  ...
  'Virgo': {
    ...
    duration: '~6 months of influence',
    planet1Energy: 'Solar Eclipse represents a MAJOR karmic reset, destiny activation, and powerful new beginning. It\'s a cosmic reboot where old chapters end and fated new ones begin. Eclipses bring sudden changes, destined events, and 6-month to 1-year transformation cycles. This is about karmic course corrections and soul-level evolution.',
    planet2Energy: 'Virgo represents service, health, organization, refinement, analysis, practical skill, and the dedicated craftsperson. It\'s the urge to improve, to be useful, to perfect your craft and serve meaningfully.',
    aspectMeaning: 'A Solar Eclipse in Virgo creates major reset in health, daily routines, work, and service. This eclipse asks: "How can you serve more meaningfully? Is your body healthy? Are your daily habits supporting or sabotaging you?" Sudden health issues or work changes force you to refine how you care for yourself and contribute to the world. Perfectionism and self-criticism must give way to practical improvement.',
  ...
  'Libra': {
    ...
    duration: '~6 months of influence',
    planet1Energy: 'Solar Eclipse represents a MAJOR karmic reset, destiny activation, and powerful new beginning. It\'s a cosmic reboot where old chapters end and fated new ones begin. Eclipses bring sudden changes, destined events, and 6-month to 1-year transformation cycles. This is about karmic course corrections and soul-level evolution.',
    planet2Energy: 'Libra represents partnership, balance, harmony, beauty, fairness, diplomacy, and relating to others. It\'s the urge to connect, to create beauty and peace, to find yourself through relationship with another.',
    aspectMeaning: 'A Solar Eclipse in Libra initiates major transformation in relationships, partnerships, and how you relate to others. This eclipse asks: "Are your relationships balanced? Do you know who you are outside of partnership? Is harmony real or just conflict avoidance?" Sudden relationship changes or partnership opportunities force you to find authentic balance between self and other. Codependence or excessive independence must give way to true partnership.',
  ...
  'Scorpio': {
    ...
    duration: '~6 months of influence',
    planet1Energy: 'Solar Eclipse represents a MAJOR karmic reset, destiny activation, and powerful new beginning. It\'s a cosmic reboot where old chapters end and fated new ones begin. Eclipses bring sudden changes, destined events, and 6-month to 1-year transformation cycles. This is about karmic course corrections and soul-level evolution.',
    planet2Energy: 'Scorpio represents transformation, depth, intensity, power, intimacy, shared resources, death and rebirth, and psychological truth. It\'s the urge to merge completely, to transform, to access hidden power.',
    aspectMeaning: 'A Solar Eclipse in Scorpio creates profound death and rebirth experience. This eclipse demands: "What must die so you can transform? What truth can you no longer avoid? Where is your real power?" Sudden crisis or transformation in intimacy, shared resources, or psychological patterns forces you to face your shadows and emerge more powerful. Superficiality dies. Authenticity and power are reborn.',
  ...
  'Sagittarius': {
    ...
    duration: '~6 months of influence',
    planet1Energy: 'Solar Eclipse represents a MAJOR karmic reset, destiny activation, and powerful new beginning. It\'s a cosmic reboot where old chapters end and fated new ones begin. Eclipses bring sudden changes, destined events, and 6-month to 1-year transformation cycles. This is about karmic course corrections and soul-level evolution.',
    planet2Energy: 'Sagittarius represents expansion, philosophy, truth-seeking, adventure, higher education, belief systems, foreign cultures, and the quest for meaning. It\'s the urge to grow beyond limits, seek truth, and find life\'s meaning.',
    aspectMeaning: 'A Solar Eclipse in Sagittarius initiates major expansion in consciousness, beliefs, and life philosophy. This eclipse asks: "What do you really believe? What gives your life meaning? Where do you need to grow?" Sudden opportunities for travel, education, or spiritual growth force you to expand beyond current limitations. Old beliefs and restrictions die so you can access greater truth and freedom.',
  ...
  'Aquarius': {
    ...
    duration: '~6 months of influence',
    planet1Energy: 'Solar Eclipse represents a MAJOR karmic reset, destiny activation, and powerful new beginning. It\'s a cosmic reboot where old chapters end and fated new ones begin. Eclipses bring sudden changes, destined events, and 6-month to 1-year transformation cycles. This is about karmic course corrections and soul-level evolution.',
    planet2Energy: 'Aquarius represents innovation, revolution, community, friendship, humanitarian ideals, individuality, technology, and the future. It\'s the urge to be uniquely yourself while contributing to collective progress.',
    aspectMeaning: 'A Solar Eclipse in Aquarius initiates radical awakening to your authentic individuality and social consciousness. This eclipse demands: "Who are you really, beyond all conditioning? What\'s your contribution to collective evolution?" Sudden changes in friendships, community involvement, or personal freedom force you to break free from conformity and embrace your unique genius. Old social masks die so authentic innovation can emerge.',
  ...
  'Pisces': {
    ...
    duration: '~6 months of influence',
    planet1Energy: 'Solar Eclipse represents a MAJOR karmic reset, destiny activation, and powerful new beginning. It\'s a cosmic reboot where old chapters end and fated new ones begin. Eclipses bring sudden changes, destined events, and 6-month to 1-year transformation cycles. This is about karmic course corrections and soul-level evolution.',
    planet2Energy: 'Pisces represents spirituality, compassion, imagination, surrender, transcendence, unity, dreams, and dissolution of boundaries. It\'s the urge to merge with something greater, to access infinite compassion and spiritual truth.',
    aspectMeaning: 'A Solar Eclipse in Pisces creates profound spiritual awakening and ego dissolution. This eclipse whispers: "Surrender. Let go. Trust something greater than yourself." Sudden spiritual experiences, compassionate callings, or creative inspiration force you to release control and trust the flow. Ego boundaries dissolve. Connection to something infinite and mystical becomes undeniable. Material concerns fade as spiritual reality intensifies.',
...
const NEW_MOONS: Record<string, NewMoonInterpretation> = {
  'Aries': {
    ...
    duration: '~2 weeks',
    planet1Energy: 'New Moon represents fresh starts, new beginnings, and planting seeds for the future. It\'s the darkest phase when the Sun and Moon align, creating a cosmic reset button. This is your monthly opportunity to set intentions, start projects, and initiate new cycles. The next two weeks favor action, initiative, and forward movement.',
    planet2Energy: 'Aries represents new beginnings, courage, independence, leadership, initiative, passion, and the warrior spirit. It\'s the spark of self-assertion, the drive to be first, and the courage to start fresh.',
    aspectMeaning: 'The New Moon in Aries is the ultimate fresh start of the zodiac year - pure initiating energy for new beginnings in identity and independence. This is your cosmic permission slip to start something new, be braver, and assert yourself more boldly. Plant seeds for who you want to become and what you want to lead. The next two weeks favor bold action, courage, and claiming your independence.',
  ...
  'Taurus': {
    ...
    planet1Energy: 'New Moon represents fresh starts, new beginnings, and planting seeds for the future. It\'s the darkest phase when the Sun and Moon align, creating a cosmic reset button. This is your monthly opportunity to set intentions, start projects, and initiate new cycles. The next two weeks favor action, initiative, and forward movement.',
    planet2Energy: 'Taurus represents stability, material security, sensory pleasure, values, persistence, patience, and building lasting resources. It\'s the energy of grounding, enjoying physical reality, and creating tangible worth.',
    aspectMeaning: 'The New Moon in Taurus is your annual opportunity to plant seeds for material security, financial growth, and pleasure. This grounding energy supports starting anything you want to last and build slowly over time. Set intentions around money, possessions, self-worth, and sensory enjoyment. The next two weeks favor patience, persistence, and practical steps toward tangible goals.',
  ...
  'Gemini': {
    ...
    planet1Energy: 'New Moon represents fresh starts, new beginnings, and planting seeds for the future. It\'s the darkest phase when the Sun and Moon align, creating a cosmic reset button. This is your monthly opportunity to set intentions, start projects, and initiate new cycles. The next two weeks favor action, initiative, and forward movement.',
    planet2Energy: 'Gemini represents communication, curiosity, learning, connections, versatility, information exchange, and mental agility. It\'s the energy of questions, conversations, siblings, short trips, and seeing multiple perspectives.',
    aspectMeaning: 'The New Moon in Gemini activates your curiosity, communication, and desire to learn. This is your annual fresh start for education, networking, and information gathering. Set intentions around improving communication skills, learning something new, connecting with others, or starting writing/teaching projects. The next two weeks favor asking questions, having conversations, and staying mentally active and versatile.',
  ...
  'Cancer': {
    ...
    planet1Energy: 'New Moon represents fresh starts, new beginnings, and planting seeds for the future. It\'s the darkest phase when the Sun and Moon align, creating a cosmic reset button. This is your monthly opportunity to set intentions, start projects, and initiate new cycles. The next two weeks favor action, initiative, and forward movement.',
    planet2Energy: 'Cancer represents emotions, nurturing, family, home, roots, security, intuition, and the protective mother energy. It\'s the urge to belong, to care for others, and to create emotional safety.',
    aspectMeaning: 'The New Moon in Cancer is your annual opportunity to plant emotional seeds, deepen family bonds, and create greater sense of belonging and security. Set intentions around emotional healing, family relationships, home improvements, or nurturing yourself and others. The next two weeks favor creating emotional safety, honoring feelings, and building deeper connections.',
  ...
  'Leo': {
    ...
    planet1Energy: 'New Moon represents fresh starts, new beginnings, and planting seeds for the future. It\'s the darkest phase when the Sun and Moon align, creating a cosmic reset button. This is your monthly opportunity to set intentions, start projects, and initiate new cycles. The next two weeks favor action, initiative, and forward movement.',
    planet2Energy: 'Leo represents creativity, self-expression, joy, confidence, recognition, leadership, romance, and the radiant performer. It\'s the urge to shine, to create, to be seen and celebrated for who you truly are.',
    aspectMeaning: 'The New Moon in Leo ignites creative spark and permission to shine. This is your annual fresh start for self-expression, creativity, romance, and claiming your spotlight. Set intentions around creative projects, leadership goals, romantic desires, or simply allowing yourself more joy and playfulness. The next two weeks favor bold self-expression and letting your authentic light shine.',
...
const FULL_MOONS: Record<string, FullMoonInterpretation> = {
  'Aries': {
    ...
    frequency: 'Once per year',
    duration: '~2 weeks',
    planet1Energy: 'Full Moon represents culminations, completions, and revelations. It\'s the peak illumination when the Sun and Moon oppose each other, bringing clarity, results, and emotional intensity. This is your monthly harvest time when projects come to fruition, truths are revealed, and situations reach breaking points or breakthroughs. The energy is about release, celebration, or letting go.',
    planet2Energy: 'Aries represents courage, independence, leadership, initiative, self-assertion, passion, and the warrior spirit. It\'s the drive to be first, the spark of new beginnings, and the courage to stand alone.',
    aspectMeaning: 'The Full Moon in Aries brings your independence, courage, and self-assertion to peak visibility. This is a culmination point for anything you started around identity, leadership, or autonomy six months ago. Issues of independence vs. partnership, courage vs. fear, and self vs. others reach climax. You see clearly where you\'ve been too passive or too aggressive, where you need to assert yourself or where you\'ve been too selfish. This moon demands balance between brave self-assertion and consideration of others.',
  ...
  'Taurus': {
    ...
    duration: '~2 weeks',
    planet1Energy: 'Full Moon represents culminations, completions, and revelations. It\'s the peak illumination when the Sun and Moon oppose each other, bringing clarity, results, and emotional intensity. This is your monthly harvest time when projects come to fruition, truths are revealed, and situations reach breaking points or breakthroughs. The energy is about release, celebration, or letting go.',
    planet2Energy: 'Taurus represents material security, stability, sensory pleasure, values, persistence, patience, and building lasting worth. It\'s the energy of grounding, tangible reality, and what you can touch and keep.',
    aspectMeaning: 'The Full Moon in Taurus illuminates your material security, values, and self-worth. This is a culmination point for financial matters, possessions, and anything related to stability you started six months ago. The tension between holding on and letting go, between security and change, between material and spiritual becomes crystal clear. You see what truly has value and what you\'ve been clinging to out of fear. This moon demands balance between building security and being open to transformation.',
  ...
  'Gemini': {
    ...
    duration: '~2 weeks',
    planet1Energy: 'Full Moon represents culminations, completions, and revelations. It\'s the peak illumination when the Sun and Moon oppose each other, bringing clarity, results, and emotional intensity. This is your monthly harvest time when projects come to fruition, truths are revealed, and situations reach breaking points or breakthroughs. The energy is about release, celebration, or letting go.',
    planet2Energy: 'Gemini represents communication, curiosity, learning, connections, mental agility, information exchange, and versatility. It\'s the energy of questions, conversations, short trips, siblings, and multiple perspectives.',
    aspectMeaning: 'The Full Moon in Gemini brings communication, learning, and information to peak clarity. This is culmination point for anything you started around education, communication, or networking six months ago. The tension between facts and meaning, between talking and listening, between versatility and depth becomes crystal clear. You see where communication has been clear or confusing, where curiosity has led to wisdom or just distraction. This moon demands balance between gathering information and integrating wisdom.',
  ...
  'Virgo': {
    ...
    planet1Energy: 'Full Moon represents culminations, completions, and revelations. It\'s the peak illumination when the Sun and Moon oppose each other, bringing clarity, results, and emotional intensity. This is your monthly harvest time when projects come to fruition, truths are revealed, and situations reach breaking points or breakthroughs. The energy is about release, celebration, or letting go.',
    planet2Energy: 'Virgo represents service, health, organization, refinement, analysis, practical skill, and the dedicated craftsperson. It\'s the urge to improve, to be useful, to perfect your craft and serve meaningfully.',
    aspectMeaning: 'The Full Moon in Virgo illuminates health, work, daily routines, and service. This is culmination of health improvements or work reorganization you started six months ago. Your body\'s condition, work efficiency, and daily habits become crystal clear. Perfectionism vs. acceptance reaches peak tension. You see what\'s actually working practically vs. what you\'ve been telling yourself. Service and usefulness tested.',
  ...
  'Pisces': {
    ...
    planet1Energy: 'Full Moon represents culminations, completions, and revelations. It\'s the peak illumination when the Sun and Moon oppose each other, bringing clarity, results, and emotional intensity. This is your monthly harvest time when projects come to fruition, truths are revealed, and situations reach breaking points or breakthroughs. The energy is about release, celebration, or letting go.',
    planet2Energy: 'Pisces represents spirituality, compassion, imagination, surrender, transcendence, unity, dreams, and dissolution of boundaries. It\'s the urge to merge with something greater, to access infinite compassion and spiritual truth.',
    aspectMeaning: 'The Full Moon in Pisces brings spirituality, compassion, and creative inspiration to peak illumination. This is culmination of spiritual practice, creative projects, or compassionate service you started six months ago. Connection to something greater reaches maximum visibility. Boundaries dissolve completely - transcendent union or confusing merger becomes obvious. Dreams manifest or reveal themselves as illusions. Compassion reaches limit or deepens into unconditional love. Surrender completes.',
...
const LUNAR_ECLIPSES: Record<string, LunarEclipseInterpretation> = {
  'Aries': {
    ...
    frequency: 'Roughly every 18-19 years in this sign',
    duration: '~6 months of influence',
    planet1Energy: 'Lunar Eclipse represents MAJOR emotional release, karmic completion, and powerful endings. It\'s a supercharged Full Moon that brings fated conclusions, necessary releases, and 6-month to 1-year purging cycles. Eclipses force what needs to end, revealing hidden truths and completing karmic patterns. This is about emotional catharsis and making space for growth.',
    planet2Energy: 'Aries represents courage, independence, leadership, initiative, self-assertion, passion, and the warrior spirit. It\'s the drive to be first, the spark of new beginnings, and the courage to stand alone.',
    aspectMeaning: 'A Lunar Eclipse in Aries brings intense emotional release around independence, self-assertion, and identity. This is a karmic completion point for patterns of people-pleasing, self-sacrifice, or losing yourself in relationships. Major endings occur in how you assert yourself - old anger, suppressed rage, or codependent patterns purge from your system. This eclipse demands you let go of who you thought you should be and release all the ways you\'ve dimmed your authentic power. Expect emotional catharsis around independence, courage, and standing alone. This is about ending cycles of weakness and birthing fierce self-reliance.',
  ...
  'Gemini': {
    ...
    planet1Energy: 'Lunar Eclipse represents MAJOR emotional release, karmic completion, and powerful endings. It\'s a supercharged Full Moon that brings fated conclusions, necessary releases, and 6-month to 1-year purging cycles. Eclipses force what needs to end, revealing hidden truths and completing karmic patterns. This is about emotional catharsis and making space for growth.',
    planet2Energy: 'Gemini represents communication, curiosity, learning, connections, mental agility, information exchange, and versatility. It\'s the energy of questions, conversations, short trips, siblings, and multiple perspectives.',
    aspectMeaning: 'A Lunar Eclipse in Gemini brings intense emotional release around communication, information, and mental patterns. This is a karmic completion point for patterns of overthinking, mental anxiety, superficial connections, or saying what others want to hear. Major endings occur in how you communicate and think - old stories you\'ve told yourself, relationships based on talk rather than truth, or mental patterns that have kept you scattered must be released. This eclipse demands you let go of lies you\'ve told, mental distractions that have kept you from feeling, and all the ways you\'ve used words to avoid emotional truth. Expect emotional purging of conversations never had, truths never spoken, and mental noise that has drowned out your intuition.',
  ...
  'Libra': {
    ...
    planet1Energy: 'Lunar Eclipse represents MAJOR emotional release, karmic completion, and powerful endings. It\'s a supercharged Full Moon that brings fated conclusions, necessary releases, and 6-month to 1-year purging cycles. Eclipses force what needs to end, revealing hidden truths and completing karmic patterns. This is about emotional catharsis and making space for growth.',
    planet2Energy: 'Libra represents partnership, balance, harmony, beauty, fairness, diplomacy, and relating to others. It\'s the urge to connect, to create beauty and peace, to find yourself through relationship with another.',
    aspectMeaning: 'A Lunar Eclipse in Libra brings intense emotional release around relationships, partnerships, and balance. This is a karmic completion point for patterns of losing yourself in relationships, people-pleasing, avoiding conflict to maintain false peace, or defining yourself through partners. Major endings occur in significant relationships - marriages, business partnerships, or closest friendships that have completed their karmic purpose must be released. This eclipse demands you let go of relationships that require you to disappear, release the need to be liked at the cost of being real, and emotionally purge all the ways you\'ve abandoned yourself for harmony. Expect dramatic relationship endings, divorces, or separations that feel devastating but are liberating.',
